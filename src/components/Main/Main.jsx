...
const Main = () => {
  const prompt1 = "Who are Kardium";
  const prompt2 = "Resources provided by Kardium";
  const prompt3 = "What is personal heart health technology?";
  const prompt4 = "What is ECG?";
      ...
      {!showResult ? (
        <>
          <div className="greet">
              ...
              <p>Welcome to the Kardium ChatBot</p>
          </div>
          <div className="cards">
